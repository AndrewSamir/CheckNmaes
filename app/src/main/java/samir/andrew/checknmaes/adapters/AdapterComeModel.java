...
public class AdapterComeModel extends RecyclerView.Adapter<AdapterComeModel.MyViewHolder> implements InterfaceAddDataToFirebase
{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements CompoundButton.OnCheckedChangeListener
    {
        ...
        public MyViewHolder(View view)
        {
            ...
            tvRvItemName.setOnCheckedChangeListener(this);
        }
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
        {
            ...
            HandleAddDataToFirebase.getInstance(activity).callAddComeToBus("flag", adapterList.get(getAdapterPosition()).getKeyString()
                    , getAdapterPosition(), status);
        }
    }

    public AdapterComeModel(List<ModelData> adapterList, Activity activity)
    {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position)
    {
        ...
        if (modelData.getComeToBus().equals("yes"))
            holder.tvRvItemName.setChecked(true);
        else
            holder.tvRvItemName.setChecked(false);

        if (modelData.getAbsent().equals("yes"))
            holder.tvRvItemName.setVisibility(View.VISIBLE);
        else
            holder.tvRvItemName.setVisibility(View.GONE);
    }
